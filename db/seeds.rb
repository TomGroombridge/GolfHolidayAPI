...
course = Course.find_by(date:  "2019-06-15")
...
Team.create(course: course, players:[player1, player3, player5, player6], score: 90)
Team.create(course: course, players:[player2, player4, player8, player9], score: 93)
